...
BestInPlaceEditor.prototype = {
    ...
    update: function () {
        ...
        // Avoid request if double check is enabled and user cancels
        if(this.doubleCheckMessage && confirm(this.doubleCheckMessage) == false) {
            this.abort();
            return true;
        }
    ...
    initOptions: function () {
        ...
        self.doubleCheckMessage = self.element.data("bip-double-check-message");
